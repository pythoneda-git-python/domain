rec {
  shellHook-for = { package, pythoneda-base, python, nixpkgsRelease }: ''
    ...
    echo -e " \033[32m| '_ \| | | | __| '_ \ / _ \| '_ \ \033[34m/ _ \\\\\033[35m/ _\` |\033[36m/ _\` |\033[33mhttps://github.com/pythoneda/git-python/tree/$PVERSION\033[0m";
    echo -e " \033[32m| |_) | |_| | |_| | | | (_) | | | |\033[34m  __/\033[35m (_| |\033[36m (_| |\033[34mhttps://github.com/pythoneda-shared/git\033[0m";
    ...
    echo -e " \033[32m|_| \033[31mD\033[36mD\033[32m |___/              \033[33mGIT-PYTHON                \033[37mhttps://patreon.com/rydnr\033[0m";
    echo;
